...
# Install repo
wget -qO- https://github.com/mobilegmYT/mcpi-packages-extended/raw/main/debs/KEY.gpg && sudo mv KEY.gpg /etc/apt/trusted.gpg.d/mcpi-reborn-extended.gpg  || error "Failed to download and add key!"

...
```bash
wget https://raw.githubusercontent.com/mobilegmYT/mcpi-reborn-extended/main/install.sh
bash install.sh
rm install.sh
```
...
```bash
wget https://raw.githubusercontent.com/mobilegmYT/mcpi-reborn-extended/main/uninstall.sh
bash uninstall.sh
rm uninstall.sh
```

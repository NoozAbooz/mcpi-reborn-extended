...
echo -e "\nInstallation complete! Please note that the MCPI Python API is still installed and can be removed with 'pip3 uninstall mcpi'. Your user data folder, '~/.minecraft-pi/' can also be removed if you want."
